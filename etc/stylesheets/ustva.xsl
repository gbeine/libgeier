...
<xsl:stylesheet xmlns:elster="http://www.elster.de/2002/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	...
	<xsl:template name="UStVA">
		...
		<tr>
			<xsl:if test="elster:Kz69">
				<td colspan="1" align="left">
					<br/>
					<small>Steuerbeträge, die vom letzten Abnehmer eines innergemeinschaftlichen Dreiecksgeschäfts geschuldet werden (§ 25b Abs. 2 UStG), in Rechnungen unrichtig oder unberechtigt ausgewiesene Steuerbeträge (§ 14 Abs. 2 und 3 UStG) sowie Steuerbeträge, die nach § 6a Abs. 4 Satz 2 oder § 17 Abs. 1 Satz 2 UStG geschuldet werden</small>
				</td>
				<td colspan="2"/>
		...
		<tr>
			<xsl:if test="elster:Jahr[starts-with(.,'2004')]">
				<xsl:if test="elster:Kz42">
					<td colspan="1" align="left">
						<br/>
						<small>Lieferungen des ersten Abnehmers (§ 25b Abs. 2 UStG) bei innergemeinschaftlichen Dreiecksgeschäften</small>
					</td>
		...
		<xsl:if test="elster:Jahr[not(starts-with(.,'2004'))]">
			...
			<tr>
				<xsl:if test="elster:Kz45">
					<td colspan="1" align="left">
						<br/>
						<big>Im Inland nicht steuerbare Umsätze</big>
					</td>
					<td colspan="1" align="center" valign="bottom">45</td>
					<td colspan="1" align="right" valign="bottom">
						<xsl:value-of select="elster:Kz45"/>
	...
	<xsl:template name="DV">
		...
		<tr>
			<td><br/>
				<big><xsl:text>I. Antrag auf Dauerfristverlängerung</xsl:text>  </big>
			</td>
	...
	<xsl:template name="SVZ">
		...
		<tr>
			<td><br/>
				<big> I. Antrag auf Dauerfristverlängerung </big>
			</td>
		</tr>
		<tr>
			<td colspan="2"> <br/>
		...
		<tr>
			<td>
				...
				<br/>
				<br/>
				<big> II. Berechnung und Anmeldung der Sondervorauszahlung auf die Steuer für das Kalenderjahr 
				...
				<table align="right" width="645" cellspacing="3">
					...
					<tr>
						<xsl:if test="elster:Kz38">
							<td colspan="1" align="left">
								<br/>
								<small>Summe der Umsatzsteuer-Vorauszahlungen zuzüglich der Sondervorauszahlung für das Kalenderjahr <xsl:value-of select="(elster:Jahr)-1"/>; davon 1/11 = Sondervorauszahlung <xsl:value-of select="elster:Jahr"/>
								</small>
							</td>
					...
					<tr>
						<xsl:if test="elster:Kz26">
							<td colspan="1" align="left">
								<br/>
								<small>Die Einzugsermächtigung wird ausnahmsweise (z.B. wegen Verrechungswünschen) für diese Umsatzsteuersondervorauszahlung widerrufen.</small>
							</td>
							<td colspan="1" align="center" valign="bottom">26</td>
							<td colspan="1" align="left" valign="bottom">
								<xsl:value-of select="elster:Kz26"/>
